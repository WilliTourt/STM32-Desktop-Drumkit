...
Pad SideStick	(Pad::ADC_2, 0     , SIDESTICK_OUT_GPIO_Port , SIDESTICK_OUT_Pin , Pad::SideStick , (_CFG_SSTK_HIT_THRESHOLD    + 1.20 * HIT_THRESHOLD_OFFSET), _CFG_SSTK_MAXF   , (Pad::ForceMappingCurve)_CFG_SSTK_FORCE_CURVE_TYPE   );
Pad Kick		(Pad::ADC_2, 1     , KICK_OUT_GPIO_Port		 , KICK_OUT_Pin		 , Pad::Kick	  , (_CFG_KICK_HIT_THRESHOLD	+ 0.70 * HIT_THRESHOLD_OFFSET), _CFG_KICK_MAXF   , (Pad::ForceMappingCurve)_CFG_KICK_FORCE_CURVE_TYPE   );
Pad Snare		(Pad::ADC_2, 2     , SNARE_OUT_GPIO_Port	 , SNARE_OUT_Pin	 , Pad::Snare	  , (_CFG_SNARE_HIT_THRESHOLD   + 0.87 * HIT_THRESHOLD_OFFSET), _CFG_SNARE_MAXF  , (Pad::ForceMappingCurve)_CFG_SNARE_FORCE_CURVE_TYPE  );
...
Pad HighTom		(Pad::ADC_3, 2     , HT_OUT_GPIO_Port		 , HT_OUT_Pin		 , Pad::HighTom	  , (_CFG_HIGHTOM_HIT_THRESHOLD + 1.20 * HIT_THRESHOLD_OFFSET), _CFG_HIGHTOM_MAXF, (Pad::ForceMappingCurve)_CFG_HIGHTOM_FORCE_CURVE_TYPE);
/**
